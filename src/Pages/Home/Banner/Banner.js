    ...
    return (
        <div className="carousel w-full">
            ...
            <div id="slide2" className="carousel-item relative w-full">
                ...
                <div className="absolute text-center text-white bg-slate-900 opacity-90 w-2/5 px-2 pt-8 h-full mr-10  justify-between transform -translate-y-1/2 left-20  top-1/2">
                    <h1 className="lg:text-5xl mx-auto md:text-2xl text-xl font-bold lg:mt-20 md:mt-10 mt-5  text-white">Data recovery from <br /> failed hard drive</h1>
                    <p className='text-2xl my-10'>We have a group of skilled workers <br /> who work with care and responsibility. <br />
                        Here you can share your problems <br /> with us with hesitation. Besides, <br /> various computer parts are available with <br /> us,   which we provide to our customers <br /> at low cost.
                    </p>
                    <div className='flex justify-center '>
                        <button className="btn btn-active btn-accent mr-3 text-white">More Info</button>
                        <button className="btn btn-active btn-secondary ml-3 text-black opacity-100 bg-white">More Info</button>
            ...
            <div id="slide3" className="carousel-item relative w-full">
                ...
                <div className="absolute text-center text-white bg-slate-700  w-2/5 px-2 pt-8 h-full mr-10  justify-between transform -translate-y-1/2 left-20  top-1/2">
                    <h1 className="lg:text-5xl mx-auto md:text-2xl text-xl font-bold lg:mt-20 md:mt-10 mt-5  text-white">Computer repairs of <br /> any complexity</h1>
                    <p className='text-2xl my-10'>We have a group of skilled workers <br /> who work with care and responsibility. <br />
                        Here you can share your problems <br /> with us with hesitation. Besides, <br /> various computer parts are available with <br /> us,   which we provide to our customers <br /> at low cost.
                    </p>
                    <div className='flex justify-center '>
